...
class _EventDetailScreenState extends State<EventDetailScreen> {
  ...
  Widget build(BuildContext context) {
    Provider.of<ActsProvider>(context);
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              'Details for event: ${widget.eventName} (ID: ${widget.eventId})',
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => TimelineScreen(eventId: widget.eventId),
                  ),
                );
              },
